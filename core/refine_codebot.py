...
class ChatBot:
    ...
    def __init__(self, api_base, model="Phind-CodeLlama-34B-v2",temperature=0, max_tokens=4096):
        ...
        self.system_prompt = ("You are an intelligent programming assistant to help user refining Java unit tests. If you provide code in your response, the code you write should be in format ```java <code> ```")
